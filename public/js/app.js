...
var RECEIVE_CLIENTS = exports.RECEIVE_CLIENTS = 'RECEIVE_CLIENTS';
...
var _vueResource = __webpack_require__(68);
...
var _Dashboard = __webpack_require__(45);
...
var _Pedidos = __webpack_require__(50);
...
var _Clientes = __webpack_require__(43);
...
_vue2.default.http.headers.common['X-CSRF-TOKEN'] = document.getElementsByName('csrf-token')[0].getAttribute('content');
_vue2.default.http.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('id_token');
...
exports.default = new _vueRouter2.default({
  ...
  routes: [{ path: '*', redirect: '/inicio' }, {
    ...
    path: '/fotos',
    name: 'Fotos',
    component: _FileUpload2.default
  }, {
    path: '/login',
    name: 'Login',
    beforeEnter: function beforeEnter(to, from, next) {
      _auth2.default.islogin(to, from, next);
    },
...
var _currency = __webpack_require__(28);
...
var _Cliente = __webpack_require__(42);

var _Cliente2 = _interopRequireDefault(_Cliente);

var _FormCliente = __webpack_require__(47);
...
exports.default = {
  ...
  methods: {
    login: function login(event) {
      ...
      _auth2.default.signin(this, this.user, this.password);
...
var _ProductList = __webpack_require__(51);
...
exports.default = {
  components: { ProductList: _ProductList2.default, Cart: _Cart2.default, Navbar: _Navbar2.default }
}; //
//
//
//
...
exports.default = {
    ...
    methods: {
        register: function register(event) {
            event.preventDefault();
            _auth2.default.register(this, this.name, this.email, this.password);
        }
    }
}; //
//
...
exports.default = {
    getClients: function getClients(clientes) {
        _vue2.default.http.get('api/users').then(function (response) {
            clientes(response.data);
        }, function (response) {
            clientes([]);
        });
    },
    addClient: function addClient(data, cb, errorCb) {
        _vue2.default.http.post('api/register', data).then(function (res) {
            cb(res.body.user);
        }, function (response) {
            if (response.status == 422) {
...
var _clients = __webpack_require__(27);
...
var getters = {
  ...
  addStatus: function addStatus(state) {
    return state.addStatus;
  },
  userSelected: function userSelected(state) {
    return state.userSelected;
  },
  addFailure: function addFailure(state) {
    return state.addFailure;
  }
};
...
var actions = {
  getAllClients: function getAllClients(_ref) {
    ...
    _clients2.default.getClients(function (clients) {
      commit(types.RECEIVE_CLIENTS, { clients: clients });
    });
  },
  addClient: function addClient(_ref2, data) {
    ...
    _clients2.default.addClient(data, function (client) {
      ...
      commit(types.ADD_FAILURE, { msgs: msgs });
    });
  },
  selectClient: function selectClient(_ref3, client) {
    var commit = _ref3.commit;

    commit(types.USER_SELECTED, { client: client });
  },
  ...
  failMensaje: function failMensaje(_ref5, msgs) {
    var commit = _ref5.commit;

    commit(types.ADD_FAILURE, { msgs: msgs });
  },
  deleteClient: function deleteClient(_ref6, data) {
...
// mutations
var mutations = (_mutations = {}, _defineProperty(_mutations, types.USER_SELECTED, function (state, _ref7) {
  var client = _ref7.client;

  state.userSelected = client;
  state.addStatus = null;
}), _defineProperty(_mutations, types.RECEIVE_CLIENTS, function (state, _ref8) {
  var clients = _ref8.clients;

  state.all = clients;
}), _defineProperty(_mutations, types.ADD_SUCCESS, function (state, _ref9) {
...
}), _defineProperty(_mutations, types.DELETE_SUCCESS, function (state, _ref10) {
  var client = _ref10.client;

  state.addStatus = 'El cliente se elimino correctamente';
}), _defineProperty(_mutations, types.ADD_FAILURE, function (state, _ref11) {
  var msgs = _ref11.msgs;
...
Component.options.__file = "D:\\proyectos\\appLaravel\\resources\\assets\\components\\Cart.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9b292c20", Component.options)
  } else {
    hotAPI.reload("data-v-9b292c20", Component.options)
  }
})()}
...
Component.options.__file = "D:\\proyectos\\appLaravel\\resources\\assets\\components\\FileUpload.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0138c0ed", Component.options)
  } else {
    hotAPI.reload("data-v-0138c0ed", Component.options)
  }
})()}
...
Component.options.__file = "D:\\proyectos\\appLaravel\\resources\\assets\\components\\FormCliente.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] FormCliente.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-027a2e14", Component.options)
  } else {
    hotAPI.reload("data-v-027a2e14", Component.options)
  }
})()}
...
Component.options.__file = "D:\\proyectos\\appLaravel\\resources\\assets\\components\\ProductList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-766189e6", Component.options)
  } else {
    hotAPI.reload("data-v-766189e6", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0138c0ed", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-027a2e14", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('Navbar'), _vm._v(" "), _c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.addStatus == null),
      expression: "addStatus == null"
    }],
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.addFailure))]), _vm._v(" "), _c('p', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.addStatus != null),
  ...
  }, [_vm._v(_vm._s(_vm.addStatus))])], 1), _vm._v(" "), _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.user.id))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.user.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.user.email))]), _vm._v(" "), _c('td', [_c('span', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "prod"
  }, [_c('Navbar'), _vm._v(" "), _c('h1', [_vm._v("Shopping Cart Example")]), _vm._v(" "), _c('hr'), _vm._v(" "), _c('h2', [_vm._v("Products")]), _vm._v(" "), _c('product-list'), _vm._v(" "), _c('hr'), _vm._v(" "), _c('cart')], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-766189e6", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "cart"
  }, [_c('h2', [_vm._v("Your Cart")]), _vm._v(" "), _c('p', {
    directives: [{
      name: "show",
      rawName: "v-show",
  ...
  }, [_c('i', [_vm._v("Please add some products to cart.")])]), _vm._v(" "), _c('ul', _vm._l((_vm.products), function(p) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-9b292c20", module.exports)
  }
}
...
var update = __webpack_require__(7)("2ca14d31", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-0138c0ed\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FileUpload.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-0138c0ed\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FileUpload.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("aae79718", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("1a825734", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
